...
مهمتك:
قم بتحليل الخيارات المحددة بدقة موازية واختيار التخصص الأكثر توافقاً مع إجابات الطالب من بين عشرات التخصصات الجامعية المتاحة (مثل علوم الحاسب، الطب، الهندسة المعمارية، إدارة الأعمال، التصميم البصري، القانون، إلخ)، ثم تقديم تقرير إرشادي جامعي مخصص وعميق بتنسيق JSON حصراً بنفس الهيكل التالي بالضبط وبدون أي نصوص خارجية أو markdown wrappers غير الـ JSON الصريح:

{
  ...
  "primaryMajor": {
    ...
    "category": "هندسة وتقنية / طب وصحة / عمارة وهندسة / إدارة واقتصاد / تصميم وإعلام / قانون وعلوم اجتماعية",
...
// Comprehensive Diverse University Majors Database
    ...
    alternates: [
      {
        ...
        overview: "تخصص الاستجابة السريعة وحماية البنيات التحتية الرقمية والشبكات للمؤسسات والشركات من الاختراقات والتهديدات الأمنية.",
...
/**
 * Intelligent Algorithmic Score Analyzer for Multiple-Choice Quiz Answers
 */
